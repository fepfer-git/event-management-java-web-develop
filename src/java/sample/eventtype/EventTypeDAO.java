...
public class EventTypeDAO {
    ...
    private static final String SEARCH_EVENT_TYPE = "SELECT eventTypeID, eventTypeName, status FROM tblEventType WHERE dbo.ufn_removeMark(eventTypeName) like ? OR eventTypeName like ?";
