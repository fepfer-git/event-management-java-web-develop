                        ...
                        <div class="header-wrapper">
                            ...
                            <div class="menu-area">
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="shop.html"><i class="icofont-diners-club-alt-1"></i>Club</a>
                                    </li>
                                    <li>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li><a href="MainController?action=profilepage" onclick="return confirm('Do you want to log out ?')" >Logout<i class="icofont-delivery-time"></i></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                        ...
                        <div class="row gy-5 align-items-center">
                            <div class="col-lg-6 col-12">
                                <div class="banner-content">
                                    ...
                                    <h1>Ravolution Music Festival</h1>
                                    ...
                                    <div class="event-sponsored">
                                        ...
                                        <img src="UserCSS/kagont/assets/images/banner/kisspng-fujifilm-logo-inkjet-paper-image-product-fujifilm-bright-bi-consulting-5b7d8fe82d2873.730738641534955496185.png"
                                             alt="sponsor">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-12">
                                <div class="banner-image">
                                    <img src="UserCSS/kagont/assets/images/banner/banner.png" alt="banner-img">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="about-image">
                                <img src="UserCSS/kagont/assets/images/banner/maxresdefault1000x480.jpg" alt="about image">
                                <a href="https://youtu.be/l53U5eY2hdc" class="play-btn" data-rel="">
                        ...
                        <div class="col-lg-10">
                            <div class="section-header text-center">
                                <h2>Ravolution Music Festival</h2>
                                <p>About Ravolution Music Festival 2022</p>
                            </div>
                            <div class="section-wrapper text-center">
                                <p class="context2">B?ng ngu?n n?ng l??ng b?t t?n t? th??ng hi?u Pin s?c Công ngh? hàng ??u Vi?t
                                    Nam, nhà tài tr? Kim C??ng Pinbus, Ravolution Music Festival ?ã có màn c?ng h??ng bùng n?,
                                    chiêu ?ãi gi?i tr? c? n??c m?t b?a ti?c âm nh?c th?nh so?n nh?t hè này. Chút n?ng l??ng cu?i
                                    cùng c?a gi?i tr? nh? b? "cu?n trôi" b?i nh?ng pha drop "h?t n??c ch?m" c?a Bassjacker (#28
                                    Top 100 DJ Mag) - "ông trùm" Bigroom s? h?u lo?t b?n hits "Psycho", "Derp", "Flip The Beat",
                                    "Crackin", ? và t?ng làm "ch?n ??ng" c?ng ??ng EDM toàn c?u t?i nh?ng l? h?i âm nh?c hoành
                                    tráng nh?t th? gi?i. Ravolution Music Festival là l? h?i âm nh?c ?i?n t? tiên phong c?a Vi?t Nam.
                                </p>
                                        ...
                                        <div class="accordion-item">
                                            <div class="accordion-header" id="headingOne">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/Logo CSG.png" alt="speaker">



                                                        <span class="h7">Lý Qu?c Lâm</span>
                                                    </span>
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <p>S? ki?n 1 prncple centered networks via magnetc
                                            ...
                                            <div class="accordion-header" id="headingTwo">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/LOGO_MEC.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="headingThree">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/Logo FTI.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="headingFour">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/logo FVC.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="headingFive">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/FStyle LOGO.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="headingSix">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/Logo FCC.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="headingSeven">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/Logo-Siti.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="headingEight">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/BEC LOGO.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="headingNine">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/FPS Logo.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="heading-One">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/FAC_Logo.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="heading-Two">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/pixlr-bg-result.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="heading-Three">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/FEV Logo .png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="heading-Four">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/LOGO EFC.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="heading-Five">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/Logo FIA.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="heading-Six">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/Logo HNF.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="heading-Seven">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/LOGO JSC.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="heading-Eight">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/LOGO_FFC_PNG.png" alt="speaker">
                                            ...
                                            <div class="accordion-header" id="heading-Nine">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="accor-header-inner d-flex flex-wrap align-items-center">
                                                        ...
                                                        <img src="UserCSS/kagont/assets/images/event/member/LOGOFBK.png" alt="speaker">
                        ...
                        <div class="row g-5">
                                ...
                                <div class="speaker-item">
                                    <div class="speaker-inner">
                                        <div class="speaker-thumb">
                                            <img src="UserCSS/kagont/assets/images/resize-event/UNLOCK.jpg" alt="speaker">
                                        </div>
                                        <div class="speaker-content">
                                            <div class="spkr-content-title">
                                                <h5><a href="speaker-details.html">Unlock The Metaverse</a> </h5>
                                                <p>CSG</p>
                                            </div>
                                            <div class="spkr-content-details">
                                                <p>?Unlock the Metaverse? là cu?c thi thi?t k? không gian ?o ??u tiên t?i Vi?t
                                                    Nam do Rove t? ch?c. Cu?c thi t?o ra sân ch?i cho nh?ng b?n tr? ?am mê sáng
                                                    t?o ???c tho? s?c th? hi?n cá tính ngh? thu?t c?a mình qua nh?ng tác ph?m 3D
                                                    trên "metaverse".</p>
                                                <ul class="social-icons">
                                                    <li><a
                                                            href="https://www.facebook.com/cocsaigonfuhcm/posts/2176107539212341"><i
                                                                class="icofont-facebook"></i></a></li>
                                                    <li><a href="mailto:csg.fptuhcm@gmail.com"><i class="icofont-email"></i></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="speaker-item">
                                    <div class="speaker-inner">
                                        <div class="speaker-thumb">
                                            <img src="UserCSS/kagont/assets/images/resize-event/Anti-backpack.jpg" alt="speaker">
                                        </div>
                                        <div class="speaker-content">
                                            <div class="spkr-content-title">
                                                <h5><a href="speaker-details.html">Anti-BackPack Day</a> </h5>
                                                <p>MEC</p>
                                            </div>
                                            <div class="spkr-content-details">
                                                <p>"Anti-BackPack Day" - Trend mà ch?c h?n các "con m?t" TikTok không th? nào
                                                    không bi?t ??n nay ?ã c?p b?n nhà ???, vào th? hai tu?n sau (??/?) câu
                                                    l?c b? ??? s? h??ng ?ng trend này. Hôm ?ó, m?i ng??i có th? ?em b?t c?
                                                    th? gì ?? ??ng ?? dùng TR? BALO ??</p>
                                                <ul class="social-icons">
                                                    <li><a href="https://www.facebook.com/Mec.Fptuhcm/posts/1007717519855054"><i
                                                                class="icofont-facebook"></i></a></li>
                                                    <li><a href="mailto:mec.fptuhcmc@gmail.com"><i
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="speaker-item">
                                    <div class="speaker-inner">
                                        <div class="speaker-thumb">
                                            <img src="UserCSS/kagont/assets/images/resize-event/H?ithao.jpg" alt="speaker">
                                        </div>
                                        <div class="speaker-content">
                                            <div class="spkr-content-title">
                                                <h5><a href="speaker-details.html"> H?i Thao Quân S? ??t 2</a> </h5>
                                                <p>FVC</p>
                                            </div>
                                            <div class="spkr-content-details">
                                                <p>? Tr? l?i l?n này, H?i thao Quân s? h?a h?n s? mang ??n cho các b?n K17 tham
                                                    gia quân s? ??t 2 m?t sân ch?i th? d?c th? thao lành m?nh, b? ích nh?ng v?n
                                                    không kém ph?n vui nh?n.
                                                </p>
                                                <ul class="social-icons">
                                                    <li><a href="https://www.facebook.com/fvchcm/posts/5562636993764976"><i
                                                                class="icofont-facebook"></i></a></li>
                                                    <li><a href="mailto:fvcvovinamclub@gmail.com"><i
                                                                class="icofont-email"></i></a></li>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="speaker-item">
                                    <div class="speaker-inner">
                                        <div class="speaker-thumb">
                                            <img src="UserCSS/kagont/assets/images/resize-event/Brave Tigers.jpg" alt="speaker">
                                        </div>
                                        <div class="speaker-content">
                                            <div class="spkr-content-title">
                                                <h5><a href="speaker-details.html">Brave Tigers</a> </h5>
                                                <p>FBC</p>
                                            </div>
                                            <div class="spkr-content-details">
                                                <p>Pick up Game n?i b? v?i ch? ?? ?Brave Tigers? chính th?c ???c kh?i tranh và
                                                    d? ?oán s? tr? thành m?t sân ch?i, n?i mà các ballers c?a chúng mình s? bùng
                                                    n? h?t mình trên tinh th?n giao l?u, h?c h?i l?n nhau.</p>
                                                <ul class="social-icons">
                                                    <li><a
                                                            href="https://www.facebook.com/fptuhcmbasketballclub/posts/440391991225289"><i
                                                                class="icofont-facebook"></i></a></li>
                                                    <li><a href="mailto:fbc.fptuhcm@gmail.com"><i class="icofont-email"></i></a>
                                                    </li>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="speaker-item">
                                    <div class="speaker-inner">
                                        <div class="speaker-thumb">
                                            <img src="UserCSS/kagont/assets/images/resize-event/t?t.jpg" alt="speaker">
                                        </div>
                                        <div class="speaker-content">
                                            <div class="spkr-content-title">
                                                <h5><a href="speaker-details.html">T?T X?A VÀ T?T NAY</a> </h5>
                                                <p>FEV</p>
                                            </div>
                                            <div class="spkr-content-details">
                                                <p>?Trong tâm trí ng??i Vi?t, T?t luôn là nh?ng hình ?nh vui t??i, quây qu?n ??y
                                                    màu s?c. Nh?ng có l? cu?c s?ng ngày càng tr? nên hi?n ??i, xô b? ?ã d?n
                                                    khi?n chúng ta quên ?i nh?ng ?i?u thiêng liêng, v?n có c?a ngày T?t.</p>
                                                <ul class="social-icons">
                                                    <li><a href="https://www.facebook.com/FPTEventClub/posts/2194348870721871"><i
                                                                class="icofont-facebook"></i></a></li>
                                                    <li><a href="mailto:fpteventclub@gmail.com"><i
                                                                class="icofont-email"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="speaker-item">
                                    <div class="speaker-inner">
                                        <div class="speaker-thumb">
                                            <img src="UserCSS/kagont/assets/images/resize-event/272265423_2994845174161856_416173377121924595_n.jpg"
                                                 alt="speaker">
                                        </div>
                                        <div class="speaker-content">
                                            <div class="spkr-content-title">
                                                <h5><a href="speaker-details.html">MV ?T?T ??N TH?T R?I?</a> </h5>
                                                <p>F#</p>
                                            </div>
                                            <div class="spkr-content-details">
                                                <p>Dù r?ng còn ??y nh?ng n?i lo: nào là công ty tr? l??ng, tình hình d?ch b?nh
                                                    còn ph?c t?p, công vi?c cu?i n?m ch?ng ch?t,... nh?ng c? m?i l?n ngh? ??n
                                                    vi?c s? ???c v? quê ?n T?t v?i gia ?ình, ng??i thân và b?n bè thì ni?m vui
                                                    b?ng tràn ng?p trong lòng mà m?i âu lo ??u tan bi?n.</p>
                                                <ul class="social-icons">
                                                    <li><a
                                                            href="https://www.facebook.com/FsharpLiveMusicClub/posts/2994845524161821"><i
                                                                class="icofont-facebook"></i></a></li>
                                                    <li><a href="mailto:fsharp.fptuhcm@gmail.com"><i
                                                                class="icofont-email"></i></a></li>
                    ...
                    <div class="section-wrapper text-center shape-b">
                        <div class="all-sponsor">
                            <div class="platinum-sponsor">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/01.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/02.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/03.png" alt="sponsor">
                                    </div>
                                </div>
                            </div>
                            <div class="gold-sponsor">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/04.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/05.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/06.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/07.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/08.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/09.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/10.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/11.png" alt="sponsor">
                                    </div>
                                </div>
                            </div>
                            <div class="silver-sponsor">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/12.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/13.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/14.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/15.png" alt="sponsor">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="UserCSS/kagont/assets/images/sponsor/16.png" alt="sponsor">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-4 justify-content-center">
                                ...
                                <div class="news-item">
                                    <div class="news-inner">
                                        <div class="news-thumb">
                                            <img src="UserCSS/kagont/assets/images/resize-event/9fe4b0e1ad4761193856w.jpg" alt="Image">
                                        </div>
                                        <div class="news-content">
                                            <h6><a
                                                    href="https://hcmuni.fpt.edu.vn/tuan-le-hang-khong-du-lich-2022-co-hoi-giao-luu-cung-vietnam-airlines-vietjet-hoa-hau-quoc-te-danh-rieng-cho-sv-dai-hoc-fpt">
                                                    Tu?n lê? Ha?ng không & Du li?ch 2022
                                                </a>
                                            </h6>
                                            <p><span><i class="fa fa-calendar" aria-hidden="true"></i>
                                                </span> February 26, 2022</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6 col-xs-12">
                                <div class="news-item">
                                    <div class="news-inner">
                                        <div class="news-thumb">
                                            <img src="UserCSS/kagont/assets/images/resize-event/fotomarathon-2022.jpg" alt="Image">
                                        </div>
                                        <div class="news-content">
                                            <h6><a href="https://hcmuni.fpt.edu.vn/fotomarathon-2022">
                                                    Cu?c Thi Nhi?p ?nh FOTOMARATHON 2022
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12">
                                <div class="news-item">
                                    <div class="news-inner">
                                        <div class="news-thumb">
                                            <img src="UserCSS/kagont/assets/images/resize-event/Bí quy?t giành H?c b?ng toàn ph?n.jpg"
                                                 alt="Image">
                                        </div>
                                        <div class="news-content">
                                            <h6><a
                                                    href="https://hcmuni.fpt.edu.vn/bi-quyet-gianh-hoc-bong-toan-phan-tham-gia-offline-on-tap-cung-mentors-hoi-san-hoc-bong">
                                                    Bí quy?t giành H?c b?ng toàn ph?n
                                                </a>
                                            </h6>
                                            <p><span><i class="fa fa-calendar" aria-hidden="true"></i>
                                                </span> April 24, 2022</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
